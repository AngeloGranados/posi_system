            ...
            <form onSubmit={(e) => handleCreateAttributes(e, FormDataAttributes)} className="flex flex-col px-2 overflow-y-auto custom-scrollbar max-h-[80vh]">
              ...
              <div className="flex items-center gap-3 mt-6 modal-footer sm:justify-end">
                ...
                >
                  ...
                  type="submit"
                  disabled={loading}
                  className={`btn btn-success btn-update-event flex w-full justify-center rounded-lg bg-red-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-600 sm:w-auto ${loading ? "opacity-50 cursor-not-allowed bg-brand-600" : ""}`}
                >
