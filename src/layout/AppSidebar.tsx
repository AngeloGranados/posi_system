...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Imagenes de Productos", path: "/images_products" },  
      { name: "Testimonios", path: "/testimonios", new: false  },
      { name: "Blog", path: "/blog", new: false  },
      { name: "Categorias de Blog", path: "/blog_categories", new: true  },
    ],
  },
  {
    icon: <UserCircleIcon />,
